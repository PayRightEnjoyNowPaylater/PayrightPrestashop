...
class payrightValidationModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $payrightAccessToken = $_POST['payrightauth'];
        $payrightSugarToken = $_POST['sugarauthtoken']; 
        ...
        $intializeTransaction = $PayRightApiCall->intializeTransaction($cart->getOrderTotal(),$payrightAccessToken,$transactionData);
